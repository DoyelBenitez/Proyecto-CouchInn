...
<div class="container">
	...
	<h3 style="text-align:center"> Couchs visitados: </h3>
	<br>
	...
	<ul class="list-group">
		...
		<?php 
			if(empty($reservas)){
				echo '<li class="list-group-item" style="text-align:center"> No ha visitado ningún couch todavía </li>';
			}
		?>	
		...
		<?php foreach ($reservas as $key => $reserva) { ?>
			...
			<div class="btn-toolbar" role="group" aria-label="...">
				...
				<?php echo '<b>'.($key+1).'.</b> '. $reserva->titulo; ?>
